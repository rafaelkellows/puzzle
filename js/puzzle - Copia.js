	        	...
	        	$('.btnConfirm').unbind('click').click(function(){
					...
					var _confirm = function(){
						//$('.questions').fadeOut('slow',function(){
							...
							$('.box._alert').removeClass('hide').addClass('show').find('div p').html("Você tem certeza da sua resposta?");
							...
							return;
							$('.box._alert').removeAttr('hide').fadeIn('fast',function(){
								$(this).find('input').click(function(){
									if( $(this).val() == "SIM" ){
										...
										$('.box._alert').fadeOut('fast');
										return;
									}
								});
							}).find('div p').html("Você tem certeza da sua resposta?");
						//});
					}
					//_confirm();
					sqPuzzle.boxConfirm(
